...
QVeris 公开 OpenAPI 提供稳定的 [JSON](https://qveris.ai/openapi.json) 和 [YAML](https://qveris.ai/openapi.yaml) 地址，并为固定版本的集成提供 [JSON](https://qveris.ai/openapi/v1.json) 与 [YAML](https://qveris.ai/openapi/v1.yaml) 地址。文档包含所有已发布操作的请求体、响应结构与示例；旧服务兼容样例仍见[投影 fixtures](https://qveris.ai/openapi/qveris-public-api.projection-fixtures.json)。
